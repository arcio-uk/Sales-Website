...
const Slide = ({
  ...
  <div className={`keen-slider__slide text-center flex w-full items-center ${className}`}>
    <div className="text-white text-5xl flex xl:flex-row flex-col w-4/5 content-center justify-center mx-auto bg-slate-800/20 xl:p-5 p-3 m-3 rounded-2xl xl:h-2/6 h-4/5 min-h-[6em]">
